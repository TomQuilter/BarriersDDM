...
Trajectories = namedtuple('Trajectories', 'actions observations')     ## MAZE 2D
# GuidedTrajectories = namedtuple('GuidedTrajectories', 'actions observations value')  - This is used for the LOCOMOTION Data with values
# Trajectories = namedtuple('Trajectories', 'actions observations values')  ... works 
